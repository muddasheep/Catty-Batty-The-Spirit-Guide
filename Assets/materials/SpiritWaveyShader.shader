...
Shader "Custom/SpiritWaveyShader"
{
...
Properties {
    ...
    _LastPosition ("Vector for Wave", Vector) = (0,0,0,0)
    _CurPosition ("Vector for Wave", Vector) = (0,0,0,0)
    _DistanceX ("Distance X", Float) = 0.0
}
...
void vert (inout appdata_full v) {
    ...
    const float4 _waveXSize = float4(0.048, 0.06, 0.24, _DistanceX * 10);
    const float4 _waveZSize = float4 (0.024, .08, 0.08, 0.2);
    const float4 waveSpeed = float4 (1.2, 2, 2.6, 1.8);
 
    //float4 _waveXmove = float4(0.024, 0.04, -0.12, 0.096);
    float4 _waveXmove = float4(0.024, 0.04, -0.12, _DistanceX);
